...
sistemas sob pressão.`,
  ...
  eletrodomesticos: {
    id: "eletrodomesticos",
    description:
      "Manutenção e reparação de eletrodomésticos e sistemas térmicos: " +
      "lava-louças, frigoríficos, exaustores, fornos, micro-ondas, AC, " +
      "termoacumuladores, painéis solares, radiadores, bombas de calor.",
...
- Climatização e energia: ar condicionado, termoacumulador, painel solar,
  radiadores, sistemas de aquecimento, aquecimento solar, bomba de calor

Nota de sobreposição: para diagnóstico técnico avançado de AC/bomba de calor
que envolva F-Gas ou ciclos de compressão em profundidade, o agente
'refrigeracao-hvac' pode complementar — usa este agente ('eletrodomesticos')
primeiro para triagem e diagnóstico geral do equipamento doméstico.
