...
de rotina.`,
  ...
  "qualidade-dados": {
    ...
    description:
      ...
      "(MIT). Útil para MesaFlow (Prisma) e ViannaLegal (Supabase).",
    systemPrompt: [
      ...
      "Relevante para o MesaFlow (Prisma/PostgreSQL) e para o ViannaLegal",
      "(Supabase, projeto knpzoqmwawmleixtulqb).",
      "",
